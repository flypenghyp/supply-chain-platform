...
const SelfOperatedPayable: React.FC = () => {
  ...
  const rowSelection = {
    ...
    getCheckboxProps: (record: PayableItem) => ({
  ...
  const handleViewDetail = (item: PayableItem) => {
    // 查看明细
    ...
    <div>
      ...
      <Card style={{ marginBottom: 16 }}>
        <AdvancedSearchFilter
          ...
          onSearch={fetchData}
          onReset={() => setFilters({ period: '', status: '', payable_no: '' })}
        />
      </Card>
      ...
      <Modal
        ...
        cancelText="取消"
      >
        {/* 内容已在 handleGenerateSettlement 中通过 Modal.confirm 展示 */}
      </Modal>
...
export default SelfOperatedPayable;
