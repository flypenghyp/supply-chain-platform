...
const RetailLeaseCounterPayable: React.FC = () => {
  ...
  const handleToggleSingleVisible = (record: LeasePayableItem) => {
        ...
        >
          <Row gutter={[16, 16]}>
            ...
            <Col xs={24} sm={12} md={8} lg={6}>
              <Input
                placeholder="专柜编码"
                value={filters.shoppe_code}
                onChange={(e) => setFilters({ ...filters, shoppe_code: e.target.value })}
                allowClear
              />
            </Col>
            <Col xs={24} sm={12} md={8} lg={6}>
...
export default RetailLeaseCounterPayable
